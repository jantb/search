...
type Data struct {
	...
	FoundAtIndex []int32  `protobuf:"varint,6,rep,packed,name=foundAtIndex" json:"foundAtIndex,omitempty"`
}
...
func (m *Event) MarshalTo(data []byte) (int, error) {
	...
	if m.Data != 0 {
		data[i] = 0x18
		i++
		i = encodeVarintSpec(data, i, uint64(m.Data))
	}
	if m.Ts != 0 {
		data[i] = 0x38
		i++
...
func (m *Data) MarshalTo(data []byte) (int, error) {
	...
	if len(m.FoundAtIndex) > 0 {
		data3 := make([]byte, len(m.FoundAtIndex)*10)
		var j2 int
...
func (m *Meta) MarshalTo(data []byte) (int, error) {
	...
	if m.Unique != 0 {
		data[i] = 0x10
		i++
		i = encodeVarintSpec(data, i, uint64(m.Unique))
	}
	return i, nil
}
...
func (m *EventRes) MarshalTo(data []byte) (int, error) {
	...
	if len(m.FoundAtIndex) > 0 {
		data5 := make([]byte, len(m.FoundAtIndex)*10)
		var j4 int
		for _, num1 := range m.FoundAtIndex {
			num := uint64(num1)
			for num >= 1<<7 {
...
var fileDescriptorSpec = []byte{
	...
	,
}
